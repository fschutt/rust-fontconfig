...
void print_usage(const char* program_name) {
    ...
    printf("  resolve <text>    - Demonstrate two-step font resolution for text\n");
    printf("  demo              - Run multilingual demo\n");
...
// Search and display font details
...
// Display detailed font information
...
// Demonstrate font resolution
int resolve_text_with_chain(FcFontCache cache, const char* text) {
    printf("Two-Step Font Resolution Demo\n\n");
    printf("Text: \"%s\"\n\n", text);
...
// Demonstrate multilingual text resolution
